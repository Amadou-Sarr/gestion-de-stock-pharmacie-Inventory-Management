...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Personnel` (
  ...
  `droit_acces` TINYINT(1) NULL,
  `recuperation` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Pharmacien` (
  ...
  PRIMARY KEY (`idPharmacien`, `Personnel_idPersonnel`),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Inventaire` (
  ...
  `numero_etagere` INT NULL,
  `Pharmacien_idPharmacien` INT NOT NULL,
  `Pharmacien_Personnel_idPersonnel` INT NOT NULL,
  PRIMARY KEY (`idInventaire`, `Pharmacien_idPharmacien`, `Pharmacien_Personnel_idPersonnel`),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Livraison` (
  ...
  PRIMARY KEY (`idLivraison`, `Fournisseur_idFournisseur`),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Medicaments` (
  ...
  `prix` DOUBLE NULL,
  `qte_en_stock` INT NULL,
  `qte_min` INT NULL,
  `date_exp` DATE NULL,
  `Inventaire_idInventaire` INT NOT NULL,
  `Livraison_idLivraison` INT NOT NULL,
  PRIMARY KEY (`idMedicaments`, `Livraison_idLivraison`),
  INDEX `fk_Medicaments_Inventaire1_idx` (`Inventaire_idInventaire` ASC),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Alertes` (
  ...
  `date` DATE NULL,
  `details` VARCHAR(255) NULL,
  `validite` TINYINT(1) NULL,
  `Medicaments_idMedicaments` INT NOT NULL,
  `Medicaments_Livraison_idLivraison` INT NOT NULL,
  PRIMARY KEY (`idAlertes`, `Medicaments_idMedicaments`, `Medicaments_Livraison_idLivraison`),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Fiche Statistique` (
  ...
  `yearlystat` INT NULL,
  `Medicaments_idMedicaments` INT NOT NULL,
  PRIMARY KEY (`idFicheStatistique`),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Vente_has_Medicaments` (
  ...
  INDEX `fk_Vente_has_Medicaments_Medicaments1_idx` (`Medicaments_idMedicaments` ASC),
...
CREATE TABLE IF NOT EXISTS `Gestion_Stock_MEMOIRE`.`Commande_has_Medicaments` (
  ...
  `Medicaments_idMedicaments` INT NOT NULL,
  `Medicaments_Livraison_idLivraison` INT NOT NULL,
  PRIMARY KEY (`Commande_idCommande`, `Medicaments_idMedicaments`, `Medicaments_Livraison_idLivraison`),
  INDEX `fk_Commande_has_Medicaments_Medicaments1_idx` (`Medicaments_idMedicaments` ASC, `Medicaments_Livraison_idLivraison` ASC),
